...
| **Scroll to element** | Smoothly scrolls the page to the first element matching a CSS selector, such as your order section. If the video is fullscreen, it leaves fullscreen first so the page can move. The video keeps playing. |
