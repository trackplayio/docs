...
Get your TrackPlay player up and running in a few steps.
...
<Note>
The TrackPlay embed script handles player initialization, responsive sizing, and cross-browser compatibility. You need only listen for the events you care about.
</Note>
