...
The sparkle button in the top bar opens **What's new**: new tutorials, blog posts, events
we attend, and product updates. A dot on the button means there is something you have not
seen yet.

Now and then one of these opens as a small popup when you sign in. You get at most one per
session, never in your first day, and never while you are editing a video, importing, setting
up a split test or on billing. Close it and it stays closed for you. It is still in What's
new if you want it later. Links open trackplay.io in a new tab.
