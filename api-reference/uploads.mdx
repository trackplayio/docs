...
<ParamField body="file" type="file" required>
  Multipart form field. Same types and the same 5 GB ceiling as the resumable protocol.
</ParamField>
<ParamField body="orientation" type="string" default="landscape">
...
<Tip>
  The ceiling is the same, but a dropped single-shot request costs you the whole file. Use
  single-shot for clips under 100 MB and the resumable protocol for anything bigger.
</Tip>
...
| | |
| --- | --- |
| File size | 5 GB per file, per orientation |
