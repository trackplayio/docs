...
### ElasticFunnels
- **Sale, refund, chargeback and renewal**: all four arrive as server postbacks
- **Session attribution**: the `vtid` value ties each one to the play that produced it
- **Verified revenue**: signed deliveries, so nothing enters your numbers unchecked
