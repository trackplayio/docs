...
<CardGroup cols={2}>
  ...
  <Card title="Kiwify" icon="cart-shopping" href="/integration/kiwify" />
...
<CardGroup cols={2}>
  <Card title="Server-side pixels" icon="satellite-dish" href="/integration/server-side-pixels">
    Meta CAPI, TikTok Events and GA4, fired from our servers so an ad blocker cannot drop
    a conversion.
  </Card>
  <Card title="RedTrack and Everflow" icon="arrow-right-arrow-left" href="/integration/postback-partners">
    A postback template with macros for click ID, payout, currency and order ID.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="CRM tagging" icon="tags" href="/integration/crm-tagging">
    Tag a viewer in GoHighLevel or ActiveCampaign based on how far they watched.
  </Card>
  <Card title="Zapier and Make" icon="bolt" href="/integration/zapier-make">
    Leads, sales and split-test winners into anything else you run.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Conversions API" icon="cart-shopping" href="/api-reference/conversions">
    Post a sale from your own backend when no cart integration covers it.
  </Card>
</CardGroup>
