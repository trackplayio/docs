...
If none is found, the sale is still recorded. It cannot be tied to a session.
...
If a browser sale later arrives again as a verified postback, it becomes verified. Nothing on your side changes.
